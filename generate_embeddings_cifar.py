...
#2. Get list of classes for CIFAR100


# Load DTD
train_dataset = datasets.CIFAR100(root='/fsx/pteterwak/data/cifar')
...
prompt_template = "### Instruction: The dataset is CIFAR100. The class name is \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
np.savez('embeddings/representations_cifar100.npz', *representation_list)
np.savez('embeddings/text_cifar100.npz', *text_list)
#
#
#
#
