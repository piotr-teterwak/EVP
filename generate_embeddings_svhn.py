...
#2. Get list of classes for SVHN
...
prompt_template = "### Instruction: The dataset is SVHN. The class name is the digit \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
np.savez('embeddings/representations_svhn.npz', *representation_list)
np.savez('embeddings/text_svhn.npz', *text_list)
#
#
#
#
