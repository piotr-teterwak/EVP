...
#2. Get list of classes for Cars


# Load StanfordCars
train_dataset = datasets.StanfordCars(root='/fsx/pteterwak/data/StanfordCars')
...
prompt_template = "### Instruction: The dataset is Stanford Cars. The class name is \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
np.savez('embeddings/representations_cars.npz', *representation_list)
np.savez('embeddings/text_cars.npz', *text_list)
#
#
#
#
