...
# Load DTD
train_dataset = datasets.EuroSAT(root='/fsx/pteterwak/data/eurosat')
...
prompt_template = "### Instruction: The dataset is EuroSAT, a sattelite imagery dataset. The class name is \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
np.savez('embeddings/representations_eurosat.npz', *representation_list)
np.savez('embeddings/text_eurosat.npz', *text_list)
#
#
#
#
