...
from util.flower_fns import flowers_class_map
...
#2. Get list of classes for Flowers12
...
prompt_template = "### Instruction: The dataset is Flowers102. The class name is \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
np.savez('embeddings/representations_flowers.npz', *representation_list)
np.savez('embeddings/text_flowers.npz', *text_list)
#
#
#
#
