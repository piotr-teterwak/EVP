...
train_dataset = datasets.CIFAR100(root='/fsx/pteterwak/data/positional_vpt_data', train=True, download=True)
...
prompt_template = "### Instruction: The dataset is CIFAR-100. The class name is \"{}\".How would you describe {} in terms of simple shapes, colors, and textures? Be detailed but succinct.  ### Assistant: "
...
#np.savez('representations.npz', *representation_list)
#np.savez('text.npz', *text_list)
#
#
#
#
